...
std::vector<double> num(double n_steps, std::vector<double> a, std::vector<double> b, std::vector<double> c, int file); //Declaration


std::vector<double> num(double n_steps, std::vector<double> a, std::vector<double> b, std::vector<double> c, int file) {
    //double a = -1;
    //double b = 2;
    //double c = -1;
